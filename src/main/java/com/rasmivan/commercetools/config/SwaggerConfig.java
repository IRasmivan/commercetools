package com.rasmivan.commercetools.config;
...
public class SwaggerConfig {  
	 ...
	 private String description = "This Project for commercetools on Spring.";
    ...
    public Docket api() { 
        ...
        )).select().paths(PathSelectors.regex("^/commercetools/api/.*$")).build();                                       
    }
}